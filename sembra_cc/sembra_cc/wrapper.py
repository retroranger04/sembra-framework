"""User-facing prediction wrapper for the charge-controlled scenario.
...
from sembra_cc.calibrations import (
    ALPHA_MAX,
    ALPHA_MIN,
    GREY_ZONE_THRESHOLD,
...
from sembra_cc.envelope import load_envelopes, predict_lambda_limit, predict_p_crit
from sembra_cc.symbolic import evaluate_det_hessian, evaluate_gradient
