"""Numerical constants for SEMBRA v2 (voltage-controlled scenario).
...
# Warm-start for the 4D equilibrium Newton solve on the grey-zone / past-limit
# branches (a, eta_0, b). lambda_0 is warm-started from the GP's lambda_limit.
