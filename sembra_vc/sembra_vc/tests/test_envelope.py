"""Tests for the voltage-controlled GP envelope module.
...
from sembra_vc.envelope import (
    load_all_envelopes,
    load_envelopes,
...
# Wrinkling-envelope training support is concentrated at low Phi for VC; keep
# these representative points inside that support so predictions stay reliable.
WRINKLE_POINTS = [(1.4, 0.06), (1.6, 0.10), (1.8, 0.14)]
